...
class Login {
    ...
    async getMicrosoft() {
        console.log('Iniciando inicio de sesión premium...');
    ...
    async getCrack() {
        console.log('Iniciando inicio de sesión no premium...');
        let popupLogin = new popup();
        ...
        connectOffline.addEventListener('click', async () => {
            if (emailOffline.value.length < 3) {
                popupLogin.openPopup({
                    title: 'Error',
                    content: 'El nombre tiene que tener mas de 3 caracteres.',
                    options: true
                });
                return;
            }
            ...
            if (emailOffline.value.match(/ /g)) {
                popupLogin.openPopup({
                    title: 'Error',
                    content: 'Tu nombre no puede contener espacios.',
                    options: true
                });
                return;
            }
            ...
            if (AZauthConnect.error) {
                ...
                connectAZauthA2F.addEventListener('click', async () => {
                    ...
                    if (AZauthA2F.value == '') {
                        PopupLogin.openPopup({
                            title: 'Error',
                            content: 'Por favor, ingrese el codigo A2F.',
                            options: true
                        });
                        return;
                    }
